# Copyright (C) 2019, 2020 Maxar Technologies (https://www.maxar.com)
...
TRANSLATIONS_RPM := $(call rpm_file2,hoot-translations,hoot_translations,noarch)
...
hoot-translations: rpmbuild-generic $(TRANSLATIONS_RPM)
