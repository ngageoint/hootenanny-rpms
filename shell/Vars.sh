...
NPM_RPM=npm-$NPM_VERSION-$NPM_RELEASE.$NODEJS_VERSION.$NODEJS_RELEASE$RPMBUILD_DIST.x86_64.rpm
V8_VERSION=$( config_version v8 )
V8_RELEASE=$( config_release v8 )
V8_RPM=v8-devel-$V8_VERSION-$V8_RELEASE.$NODEJS_VERSION.$NODEJS_RELEASE$RPMBUILD_DIST.x86_64
