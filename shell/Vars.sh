...
GPSBABEL_VERSION=$( config_version gpsbabel )
GPSBABEL_RELEASE=$( config_release gpsbabel )
GPSBABEL_RPM=gpsbabel-$GPSBABEL_VERSION-$GPSBABEL_RELEASE$RPMBUILD_DIST.x86_64.rpm
GPSBABEL_DEVEL_RPM=gpsbabel-devel-$GPSBABEL_VERSION-$GPSBABEL_RELEASE$RPMBUILD_DIST.x86_64.rpm
