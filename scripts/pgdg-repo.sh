...
cat > /etc/yum.repos.d/pgdg-$PG_DOTLESS-centos.repo <<EOF
[pgdg${PG_DOTLESS}]
...
baseurl=https://download.postgresql.org/pub/repos/yum/srpms/${PG_VERSION}/redhat/rhel-\$releasever-\$basearch
enabled=0
gpgcheck=1
gpgkey=file://${PGDG_KEY}
EOF
