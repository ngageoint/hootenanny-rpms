...
su -l "$RPMBUILD_USER" -s /bin/sh -c "curl -sSL -O $SONAR_URL/$SONAR_ZIP"

echo "### Installing Sonar Scanner..."
su -l "$RPMBUILD_USER" -s /bin/sh -c "unzip -qq -o $SONAR_ZIP"
...
su -l "$RPMBUILD_USER" -s /bin/sh -c "curl -sSL -O $SONAR_BLD_URL/$SONAR_BLD_ZIP"

echo "### Installing Sonar Build Wrapper..."
su -l "$RPMBUILD_USER" -s /bin/sh -c "unzip -qq -o $SONAR_BLD_ZIP"
