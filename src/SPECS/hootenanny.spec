...
BuildRequires:  git glpk-devel libicu-devel nodejs-devel opencv-devel
...
HootTest --exclude=.*RubberSheetConflateTest.sh --exclude=.*ConflateCmdHighwayExactMatchInputsTest.sh --slow
