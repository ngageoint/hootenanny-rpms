...
%{!?postgisprevmajorversion:%global postgisprevmajorversion 2.4}
...
Patch0:		postgis-%{postgismajorversion}-gdalfpic.patch
...
export LDFLAGS="$LDFLAGS -L%{pginstdir}/lib"
...
%changelog
%if "%{postgismajorversion}" == "2.5"
* Thu Jun 06 2019 Justin Bronn <justin.bronn@maxar.com> - 2.5.2-1
- Initial release, version 2.5.2.
%endif
%if "%{postgismajorversion}" == "2.4"
* Thu Jun 06 2019 Justin Bronn <justin.bronn@maxar.com> - 2.4.7-1
- Upgrade to 2.4.7.
